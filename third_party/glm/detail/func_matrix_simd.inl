...
namespace glm {
    ...
    outerProduct<float, aligned_lowp, tvec4, tvec4>(tvec4<float, aligned_lowp> const &c,
    ...
    outerProduct<float, aligned_mediump, tvec4, tvec4>(tvec4<float, aligned_mediump> const &c,
    ...
    outerProduct<float, aligned_highp, tvec4, tvec4>(tvec4<float, aligned_highp> const &c,
